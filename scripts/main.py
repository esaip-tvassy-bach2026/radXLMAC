...
"""
# from programe.py import lancement_programme
...
def menu_principal(confirm):
    ...
    print("\n")
    nombre_radios=int(input("Combien d-adresses MAC radio a votre point d-accès Wi-Fi ? Veuillez entrer un nombre entier. "))
