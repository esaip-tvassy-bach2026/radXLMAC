...
radXLMAC - Enhance your MAC address calculations within Microsoft Excel files.
Copyright (C) TIMCOD SAS, 2025-2030. All rights reserved.
Copyright (C) TIMCOD OUEST SAS, 2025-2030. All rights reserved.
...
def charger_colonnes(fichierc,nb_radios,col_phys,col1,col2,col3=None,col4=None,col5=None,col6=None,ligne_depart=2):
    """
